...
If you want to see this architecture in action, [install Bani](https://docs.bani.dev/getting-started) and try a migration. The source code is available on [GitHub](https://github.com/mugumedavid/bani) under the Apache-2.0 license.
