#!/usr/bin/env python3
"""Migrate a MSSQL database to MySQL using Bani connectors.

Usage:
    docker compose up -d mssql mysql
    export MSSQL_USER=sa MSSQL_PASS='BaniTest123!'
    export MYSQL_USER=bani_test MYSQL_PASS='bani_test'
    python scripts/10_migrate_mssql_to_mysql.py
"""
