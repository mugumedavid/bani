#!/usr/bin/env python3
"""Migrate a Oracle database to SQLite using Bani connectors.

Usage:
    docker compose up -d oracle
    export ORACLE_USER=bani_test ORACLE_PASS='bani_test'
    python scripts/17_migrate_oracle_to_sqlite.py
"""
